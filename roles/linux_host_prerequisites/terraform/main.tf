...
locals {
  contract_version = "sha256:f00cbaca0e532932b1e72b7951e7a795da6feefbb0d949857f82bed3ada0ea14"
  payload = {
    docker_daemon_config = var.arguments.docker_daemon_config
    reboot_on_change = var.arguments.reboot_on_change
  }
